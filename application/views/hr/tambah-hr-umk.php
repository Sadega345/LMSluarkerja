            ...
            <div class="block-header">
                <div class="row">
                    <div class="col-lg-6 col-md-8 col-sm-12">
                         <h6 class="tittle-menu"><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a> Pengaturan / Master Data / Tambah UMK</h6>
                    </div>
                </div>
            </div>
             ...
             <div class="row clearfix">
                 <div class="col-lg-12 col-md-12">
                    ...
                    <div class="container">
                        <form method="post" action="<?php echo base_url()?>HR/ProsesTambahUMK   " enctype="multipart/form-data">
                        <div class="row">
