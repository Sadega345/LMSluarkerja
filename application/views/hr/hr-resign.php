                                ...
                                <div class="row  m-t-20">
                                    ...
                                    <div class="col-md-4" align="left" >
                                        <select name="status_karyawan" class="form-control fcheight">
                                            ...
                                            <option value="2" <?php //echo $this->input->post('status_karyawan')=='2'?'selected':''; ?>>Kontrak</option>
                        ...
                        <div class="body">
                            ...
                            <div class="table-responsive">
                                <table  class="table table-hover js-basic-example dataTable table-custom table-striped table-bordered nowrap dataTable dtr-inline " style="width: 100%">
                                    ...
                                    <tbody>
                                    <?php foreach ($dataResign->result() as $dt) { ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="javascript:;" onclick="viewinforesign('<?php echo $dt->nik ?>')" class="btn btn-aksi"><img src="<?php echo base_url() ?>assets/img/View.svg" class="padd-right-5">lihat</a>
                                ...
                                <div class="body">
                                    <div class="row">
                                        <div class="col-lg-6 col-md-6">
                                            <label class="fz-18"> Resign</label>
                            ...
                            <form action="<?php echo base_url()?>HR/ProsesEditResign" method="post">
                                <div class="col-lg-12">
                                    <div class="body">
                                        <div class="row">
                                            <div class="col-lg-6 col-md-6">
                                                <label class="fz-18">Edit Resign</label>
            ...
            <script type="text/javascript">
                ...
                function formedit(a){
                    // alert('nik: '+a);
                    $.ajax({
                      url: "<?php echo base_url();?>HR/EditHRResign/"+a,
                      // data: {nik:a},
                      type: "post",
                      // dataType:'json',
                ...
                function viewinforesign(a){
                        $.ajax({
                            url: "<?php echo base_url();?>HR/ViewHRResign/"+a,
                            // data: {nik:a},
                            type: "post",
                            // dataType:'json',
                            success: function (response) {
