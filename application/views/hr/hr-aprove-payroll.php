            ...
            <div class="block-header">
                <div class="row">
                    <div class="col-lg-6 col-md-8 col-sm-12">
                         <h6 class="tittle-menu"><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a> Keuangan / Payroll Creator</h6>
                    </div>
                </div>
            </div>
                         ...
                         <div class="body">
                            <div class="row">
                                <div class="col-md-3 col-3 ">
                                    <a href="<?php echo base_url() ?>HR/HRUploadDataPayroll" class="btn btn-darkblue">Draft</a>
                                </div>
                                <div class="col-md-12 m-t-10 col-12 text-center" align="center">
                         ...
                         <div class="body">
                            <div class="row">
                               ...
                               <div class="col-md-6 col-6" align="right">
                                    <a href="<?php echo base_url()?>HR/spreadsheet" class="btn btn-blue col-md-6">Download CSV</a>
                               </div>
                            </div>
