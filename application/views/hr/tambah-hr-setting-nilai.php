            ...
            <div class="block-header">
             ...
             <div class="row clearfix">
                 <div class="col-lg-12 col-md-12">
                    ...
                    <div class="container">
                        <form method="post" action="<?php echo base_url()?>Outsource/ProsesTambahHRSettingNilai" enctype="multipart/form-data">
                            ...
                            <input type="hidden"  name="id_master_jenis_project" value="<?php  echo $this->uri->segment(5) ?>">
                            <div class="row">
