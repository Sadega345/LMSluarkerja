                                ...
                                <div class="col-md-12" align="left">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-12">
                                            ...
                                            <div class="row form-group">
                                                <div class="col-md-6 col-12">
                                                    <p class="hidden-sm fz-14">Disetorkan </p>
                                                    <p class="d-sm-none fz-14">Disetorkan </p>
                                                </div>
                                                <div class="col-md-6 col-12">
                                                    <?php 
                                                        $totdisetorkan=$tmplemburan+$rows->disetorkan;
                                                     ?>
                                                    <p class="fz-14 hitamsemu">Rp. <?php echo number_format($totdisetorkan,0,'.','.')?></p>
                                                </div>
                                            </div>
