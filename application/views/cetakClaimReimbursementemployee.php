            ...
            <table >
                <tr>
                    <td align="center" rowspan="4" width="10%">
                        ...
                        <img src="<?php echo str_replace("index.php","",$_SERVER["SCRIPT_FILENAME"]) ?>/assets/logo_perusahaan/<?php echo $dataKlaim->logo!=""?$dataKlaim->logo:"not.png" ?>" width="125px" height="50px" />
                    </td>
        ...
        <div class="full-widtha">
            <table>
                <tr>
                    ...
                    <td>:</td>
                    <td colspan="4" style="text-align: left;"><?php echo $dataKlaim->nama_lengkap ?>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>:</td>
                    <td colspan="4" style="text-align: left;"><?php echo $dataKlaim->nik ?>
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>:</td>
                    <td colspan="4" style="text-align: left;">Rp. <?php echo number_format($dataKlaim->total,0,'.','.'); ?>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>:</td>
                    <td colspan="4" style="text-align: left;"><?php echo strftime(" %d %B %Y",strtotime($dataKlaim->tanggal)); ?>
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>:</td>
                    <td colspan="4" style="text-align: left;"><?php if($dataKlaimFile->num_rows()>0){
                                    echo "Ada";
                                }else{
                                    echo "Tidak Ada";
                                }?>
                ...
                <tr>
                    <td>
                        <h4 style="text-align: left;">Ketrangan Klaim</h4>
                    </td>
                    <td>:</td>
                    <td colspan="4" style="text-align: left;"><?php echo $dataKlaim->deskripsi; ?>
                    </td>
                </tr>
                <tr>
                    <td>
                        <h4 style="text-align: left;">Alasan Penolakan/Approve</h4>
                    </td>
                    <td>:</td>
                    <td colspan="4" style="text-align: left;"><?php echo $dataKlaim->alasan; ?>
                    </td>
                </tr>
                <tr>
                    <td>
