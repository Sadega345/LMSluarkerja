...
<div class="row clearfix">
    <div class="col-lg-12 col-md-12 col-sm-12">
        <div class="card">
            <h6 class="tittle-box text-center m-t-30">Tambah Jenis Projek</h6>
            <div class="body">
            	<form method="post" id="simpan" action="<?php echo base_url() ?>Outsource/TambahPOJenisProjek">
            		<div class="form-group">
		              <label>Jenis Projek  :</label>
		              <input type="text" class="form-control" required name="nama_departemen" placeholder="Jenis Projek">
		            </div>
		            <div class="form-group">
