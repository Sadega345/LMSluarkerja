            ...
            <div class="block-header">
                <div class="row">
                    <div class="col-lg-6 col-md-8 col-sm-12">
                         <h6 class="tittle-menu"><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a> Master  / Edit UMK</h6>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card  ">
                        <div class=" row p-15 ">
                            ...
                            <div class="col-md-8 text-center col-12" >
                                 <h6 class="tittle-box">Edit UMK</h6>
                            </div>
                            <div class="col-md-2 col-4">
                            </div>
                        </div>
                    <div class="container">
                        <form method="post" action="<?php echo base_url()?>Outsource/ProsesEditUMK" enctype="multipart/form-data">
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <input type="text" name="gaji" class="form-control" required value="<?php echo $dataumk->gaji ?>" onkeypress="//return hanyaAngka(event)">
                            </div>
                        </div>
