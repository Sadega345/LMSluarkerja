    ...
    <div class="col-lg-12 col-md-12 col-sm-12">
        <div class="card">
            ...
            <?php 
            	...
            	$arr = array();
            	$hitung = substr_count($tmp, "-P");
            	$num = 0;
            	$no_po = $dataProjectOrder->no_projek_order;
            	if ($hitung > 0) {
            		$arr = explode("-P", $tmp);
                    $last = array_pop($arr);
                    $arr = array(implode('_', $arr), $last);
            		$no_po = $arr[0];
            		$num = $arr[1];
            	}
            	// echo $no_po;
            ...
            <div class="body">
            	<form method="post" id="simpan" action="<?php echo base_url() ?>Outsource/prosesTambahBaru">
            		...
            		<input type="hidden" name="id_projek_order_perpanjangan" value="<?php echo $this->uri->segment(4)?>">
                    <!--
            		<div class="row">
		                <div class="col-md-3">
			                <div class="form-group">
			                    <label>Nomor Dokumen :</label>
			                    <input type="text" class="form-control" name="nomor_dokumen" required placeholder="Nomor Dokumen" value="<?php //echo $dataProjectOrder->nomor_dokumen ?>">
			                </div>
		                </div>
		                <div class="col-md-3">
			                <div class="form-group">
			                    <label>Tanggal Terbit :</label>
			                    <input type="date" class="form-control" name="tanggal_terbit" required placeholder="Tanggal Terbit" value="<?php //echo $tglTerbit[0] ?>">
			                </div>  
		              	</div>
		                <div class="col-md-3">
			                <div class="form-group">
			                    <label>Revisi :</label>
			                    <input type="text" class="form-control" name="revisi" required placeholder="Revisi" value="<?php //echo $dataProjectOrder->revisi ?>">
			                </div>  
		              	</div>
		              	<div class="col-md-3">
			                <div class="form-group">
			                     <label>Halaman :</label>
			                    <input type="text" class="form-control" name="halaman" required placeholder="Halaman" value="<?php //echo $dataProjectOrder->halaman ?>">
			                </div>  
		              	</div>
		            </div>
                    -->
		                ...
		                <div class="col-md-6">
		                 ...
		                 <div class="col-md-6">
			                <div class="form-group">
			                    ...
			                    <input type="text" class="form-control datepicker2" data-id="datepicker2" required placeholder="Tanggal Perpanjangan" readonly value="<?php echo $tanggal_adendum_or_perpanjang ?>">
			                    <input type="hidden" name="tanggal_perubahan" id="datepicker2">
			                </div>  
		              	</div>
		            </div>
	                ...
	                <div id="wizard_horizontal">
	                    ...
	                    <section>
                            ...
                            <div class="form-group">
                                ...
                                <br>
                                <label class="fancy-radio">
                                    <!-- <input type="radio" name="pemberian_lembur_tiap_tanggal" value="1" required="" data-parsley-errors-container="#error-radio" data-parsley-multiple="beri_lembur" <?php //echo in_array(1, $pemberianlemburtiaptanggal)?'checked':""; ?>>
                                    <span><i></i>01</span> -->
                                    <select name="pemberian_lembur_tiap_tanggal" class="form-control select2 " required>
					              			<option disabled selected="" value="0">Tanggal</option>
	                                	<?php for ($i=1; $i<=31  ; $i++) { ?>
				            ...
				            <div class="form-group">
                                ...
                                <br>
                                <label class="fancy-radio">
                                   <!--  <input type="radio" name="penggajian_tiap_tanggal" value="1" data-parsley-errors-container="#error-radio" data-parsley-multiple="penggajian" <?php //echo in_array(1, $penggajiantiaptanggal)?'checked':""; ?>>
                                    <span><i></i>01</span> -->
                                    <select name="penggajian_tiap_tanggal" class="form-control select2 " required>
					              			<option disabled selected="" value="0">Tanggal</option>
	                                	<?php for ($i=1; $i<=31  ; $i++) { ?>
