            ...
            <div class="body">
            	<form method="post" id="simpan" action="<?php echo base_url() ?>Outsource/EditPOJenisProjek">
            		<div class="form-group">
                      ...
                      <input type="hidden" class="form-control" required name="id" value="<?php echo $dataJenisProjek->id_master_departemen ?>">
		              <input type="text" class="form-control" required name="nama_departemen" placeholder="Jenis Projek" value="<?php echo $dataJenisProjek->nama_departemen ?>">
		            </div>
		            <div class="form-group">
