                    ...
                    <table  class="table table-hover js-basic-example dataTable table-custom table-striped table-bordered nowrap dataTable dtr-inline " style="width: 100%">
                        ...
                        <tbody>
                          ...
                          foreach ($dataJenisProjek->result() as $data_jenisprojek) { ?>
                            ...
                            <tr>
                                <td><?php echo $no++; ?></td>
                                <td><?php echo $data_jenisprojek->jenis_project; ?></td>
                                <td>
                                    <a href="<?php echo base_url()?>Outsource/PO_EditJenisProjek/<?php echo $data_jenisprojek->id_master_jenis_project ?>">
                                        <button class="btn btn-warning">Edit</button>
                                    </a> 
                                    <a href="javascript:;"  class="btn btn-danger hapus"  title="Hapus">Hapus
                                    </a>
                                </td>
                            </tr>
                          <?php } ?>
            ...
            buttonsStyling: false,
                  ...
                  swalWithBootstrapButtons.fire({
                      ...
                      if (result.value) {
                         $.ajax({
                              type: 'POST',
                              url: "<?php echo base_url()?>Outsource/HapusPOJenisProjek/<?php echo $data_jenisprojek->id_master_jenis_project ?>",
