...
<div class="row clearfix">
    <div class="col-lg-12 col-md-12 view" >
         <div class="card ">
             <div class="body">
                <h6 class="tittle-box text-center">Project Order Baru</h6>
                          ...
                          <?php foreach ($dataProjectOrder->result() as $dataProject_Order) { ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <p><a href="<?php  echo base_url() ?>Outsource/PO_dtl/<?php echo $dataProject_Order->status;  ?>/<?php echo $dataProject_Order->idporev==""?$dataProject_Order->id_po:$dataporev->id_po;  ?>">
